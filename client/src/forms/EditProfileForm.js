...
const FormFieldElement = (props)=>(
  ...
  const FormSchema = Yup.object().shape({
    ...
    bio: Yup.string(),
    img: Yup.string().matches(/((([A-Za-z]{3,9}:(?:\/\/)?)(?:[-;:&=\+\$,\w]+@)?[A-Za-z0-9.-]+|(?:www.|[-;:&=\+\$,\w]+@)[A-Za-z0-9.-]+)((?:\/[\+~%\/.\w-_]*)?\??(?:[-\+=&;%@.\w_]*)#?(?:[\w]*))?)/, "Must be a valid URL"),
            ...
            <div style={{ marginTop: 15 }} className="row">
              <FormFieldElementWide>
                ...
                <Field
                  ...
                  name="bio"
                  className="form-control"
                  placeholder={props.user.bio ?? 'Tell us what makes you bad ass?  You can show us later!'}
                />
